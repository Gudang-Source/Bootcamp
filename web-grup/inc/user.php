...
?>
<a target="blank" href="./assets/img/user/user.png"><img style="float:left; margin-right:10px;width:250px;height:250px;" src="./assets/img/user/user.png" class="img-thumbnail"></a>
<?php
}
else{
?>
