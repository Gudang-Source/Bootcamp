...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./">MANAJEMEN INFORMATIKA<br><i style="font-size:10px;"></i></a>
            </div>
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    <li>
                        ...
                        if ($data2["pp_user"] == '') {
                         ?>
                         <a  href="./assets/img/user/user.png"><img src="assets/img/user/user.png" class="img-thumbnail"></a>
                         <?php
                        }
                        else{
                        ?>
    ...
    <div id="footer-sec">
        &copy; MANAJEMEN INFORMATIKA <span style="float:right;">Design By : <b>TREIDO DAN GOOGLE</b>
    </div>
    <!-- /. FOOTER  -->
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa fa-users "></i>Pengguna FORUM<span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level">
                            <li>
