...
?>
        <div class="box-header">
				 <font face=times new roman><center><h4> =PENGUMUMAN= </h4></center>
				 
				 <?php 
				      $tampil = mysql_query("SELECT * FROM rb_pengumuman_siswa ORDER BY nama_p_siswa DESC");
                    while($r=mysql_fetch_array($tampil)){
                    echo "<td><center style='padding:35px; color:red;'>$r[nama_p_siswa]</td></font>";
                         }
                  ?>
              </div>
          </div>
