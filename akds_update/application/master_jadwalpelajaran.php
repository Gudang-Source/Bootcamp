            ...
            <div class="col-xs-12">  
              <div class="box">
                <div class="box-header">
                  ...
                  <a class='pull-right btn btn-primary btn-sm' href='index.php?view=jadwalpelajaran&act=tambah'>Tambahkan Jadwal Pelajaran
                  </a>
                  <?php 
                  echo "<a class='pull-right btn btn-success btn-sm' target='_BLANK' href='print-jadwal.php?tahun=$_GET[tahun]&kelas=$_GET[kelas]&kurikulum=$kurikulum[kode_kurikulum]'>Print</a>";
                  ?>
