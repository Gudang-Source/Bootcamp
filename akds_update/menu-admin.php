<section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <!--<li class="treeview">
              <a href="#"><i class="fa fa-calendar"></i> <span>Penilaian Raport KTSP</span><i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
            ...
            <li class="treeview">
              <a href="#"><i class="fa fa-user"></i> <span>Pengumuman</span><i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="index.php?view=pengumuman"><i class="fa fa-circle-o"></i> Pengumuman Siswa</a></li>
                <li><a href="index.php?view=pengumuman_g"><i class="fa fa-circle-o"></i> Pengumuman Guru</a></li>
              </ul>
            </li>


          <li class="treeview">
              <a href="#"><i class="fa fa-calendar"></i> <span>Penilaian Raport K13</span><i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="index.php?view=raportuts"><i class="fa fa-circle-o"></i> Data Nilai UTS</a></li>
                <li><a href="index.php?view=raportcetakuts"><i class="fa fa-circle-o"></i> Cetak Raport UTS</a></li>
               <li><a href="index.php?view=catatan"><i class="fa fa-circle-o"></i> Catatan Wakel</a></li>
                <li><a href="index.php?view=capaianhasilbelajar"><i class="fa fa-circle-o"></i> Data Capaian Belajar</a></li>
                <li><a href="index.php?view=extrakulikuler"><i class="fa fa-circle-o"></i> Data Extrakulikuler</a></li>
                <li><a href="index.php?view=prestasi"><i class="fa fa-circle-o"></i> Data Prestasi</a></li>
                <li><a href="index.php?view=raport"><i class="fa fa-circle-o"></i> Data Nilai Raport</a></li>
