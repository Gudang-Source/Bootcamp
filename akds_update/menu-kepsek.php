<section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="index.php?view=pengumuman"><i class="fa fa-file"></i><span>Pengumuman Siswa</span></a></li>
            <li><a href="index.php?view=pengumuman_g"><i class="fa fa-users"></i><span>Pengumuman Guru</span></a></li>
