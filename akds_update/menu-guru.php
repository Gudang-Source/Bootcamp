<section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="index.php?view=pengumuman"><i class="fa fa-file"></i><span>Pengumuman Siswa</span></span></a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="index.php?view=catatan&act=detailguru"><i class="fa fa-circle-o"></i> Catatan Wali Kelas</a></li>
