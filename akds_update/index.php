      ...
      <div class="content-wrapper">
        ...
        <?php 
          ...
          elseif ($_GET[view]=='raport'){
            ...
            cek_session_guru();
            echo "<div class='row'>";
                    include "application/raport/raport_catatan.php";
            echo "</div>";
            ...
            cek_session_guru();
            echo "<div class='row'>";
                    include "application/master_pengumuman_s.php";
            echo "</div>";
          }elseif ($_GET[view]=='pengumuman_g'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/master_pengumuman_guru.php";
            echo "</div>";
          }
